...
function Congrats() {
    ...
    return <div>
        <div className="congreats-text">
            ...
            <div><img src={`${assetUrl}/congreates-img.png`} alt="" className="con-img" /></div>
            <h4 className="primary-color">Congratulation!</h4>
            <h4 className="primary-color">You won <span>{location.state.coins}</span> VCoins.</h4>
