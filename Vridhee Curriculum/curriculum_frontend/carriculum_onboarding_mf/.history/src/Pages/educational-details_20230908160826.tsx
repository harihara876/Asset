                    ...
                    >
                        <div className="page-wrapper">
                            ...
                            <div className="inner-page-content">
                                ...
                                <div className="skip-this-btn">
                                    <button type="button" className="btn" onClick={profession}>Skip this step</button>
                                </div>
                                    ...
                                    {!Show && <form id="personData" noValidate>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleFormControlSelect1">Start Date<sup>*</sup></label>
                                                <div className='float-left'>
                                                    {/* <select className="form-control" name="location" id="exampleFormControlSelect1"
                                                        placeholder='some' value={startMonth} onChange={startMonthSelect}>
                                          ...
                                          name="startdate" id="startdate" value={startMonth} 
                                            ...
                                            selectedValue={startMonth} />
                                                ...
                                                <div className='float-right'>
                                                    {/* <select className="form-control" name="location" id="exampleFormControlSelect1"
                                                        placeholder='some' value={startYear} onChange={startYearSelect}>
                                        ...
                                        <div className="form-group">
                                            ...
                                            {/* <select className="form-control" name="location" id="exampleFormControlSelect1"
                                              ...
                                              <Dropdown    name="gradeVal" id="gradeVal" value={selectGrade}  options={grades}   title="-Select-" selectStyle="w-100"
