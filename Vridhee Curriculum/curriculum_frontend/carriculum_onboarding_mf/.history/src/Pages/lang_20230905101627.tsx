...
const dataval = ["English", "Telugu", "Hindi"];
const datava2 = ["Hyderabad", "Vijayawada", "Visakhapatnam"];
                        ...
                        <form >
                            <div className="select-language mt-3">
                                <div className="form-group">
                                    ...
                                    <CustomSelect data={dataval}
                                        title="Select Language"
                                        onSelectChange={(event: any) => console.log(`Got ${event.target.value}`)} />
                                </div>
                                <div className="form-group">
                                    <label>Where are you from?</label>
                                    <CustomSelect data={datava2}
                                        title="Select Language"
                                        onSelectChange={(event: any) => console.log(`Got ${event.target.value}`)} />
                                </div>
