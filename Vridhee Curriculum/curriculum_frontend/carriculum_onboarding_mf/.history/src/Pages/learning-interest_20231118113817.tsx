                                                ...
                                                {(data.have_mentor != 'Yes') ?       <div className="list-group">
                                                    ...
                                                    <div className='list-gropu-box'>
                                                        ...
                                                        <div className="list-gropu-box-con">
                                                            <div>
                                                                <span className="float-left"><h4>Suresh</h4></span>
                                                                <span className="float-right green-color">Highly recommended</span>
                                                                <div className="clearfix"></div>
                                                                <p>Holding five years of professional experience</p>
                                                            </div>
                                                        </div>
                                                        <div className="clearfix"></div>
                                                    </div>
                                                       ...
                                                       <div className="select-checkbox">
                                                        ...
                                                        <div className="list-gropu-box-img">
                                                            {/* <img src={`${assetUrl}/details-img.png`} alt="" /> */}
                                                            <img src="https://img.freepik.com/free-photo/portrait-beautiful-woman-with-glasses_23-2148418596.jpg?size=626&ext=jpg&ga=GA1.1.1413502914.1696982400&semt=ais" alt="" />
                                                        </div>
                                                        <div className="list-gropu-box-con">
                                                            <div>
                                                                <span className="float-left"><h4>Shekar G</h4></span>
                                                                <span className="float-right green-color">Highly recommended</span>
                                                                <div className="clearfix"></div>
                                                                <p>Holding 4 years of professional experience</p>
                                                            </div>
                                                        </div>
                                                        <div className="clearfix"></div>
                                                    </div> 
