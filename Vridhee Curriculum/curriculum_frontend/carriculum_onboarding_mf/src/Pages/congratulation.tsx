...
function Congrats() {
    ...
    return <div>
        <div className="congreats-text">
            ...
            {location.state.coins ? <h4 className="primary-color w-100">You won <span>{location.state.coins}</span> VCoins.</h4> : <h4 className="primary-color">You won 0 VCoins.</h4>}
            <AppButton onClick={goNext} children="Do you want to continue to win more vcoins" styleClass='btn save-btn mt-2 pt-2 pb-2' />
        </div>
    </div>
}
