...
export default function AnswerTab() {
    ...
    const back = (data:any) => {
        console.log(data,"data")
        const dataRes = { subId: data.sub_id,topicId: data.t_id, topicName: data.topicName, chapterName: data.chapName};
    ...
    return (
        <div>
            ...
            <div className="backto-dought mb-2" style={{ 'cursor': 'pointer' }} onClick={() => back(doubtAnswers)}>
                                                ...
                                                <span className="float-right">
                                                    <i className="fa fa-pencil"
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            setSubId(doubtAnswers.sub_id!)
                                                    setTopicId(doubtAnswers.t_id)
                                                    setChapterId(doubtAnswers.chapter_id)
